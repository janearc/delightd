...
// reads the same SR delightd already publishes to (see pkg/events) -- this is the read half
// of that connection, not a new dependency.
...
// SR outage fails the check loudly rather than silently admitting an unverifiable claim.
